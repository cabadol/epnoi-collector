...
public class RSSTest extends CamelTestSupport{
    ...
    public void rssMessage() throws Exception {
        ...
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_TITLE,"EU Free Data Roaming, Net Neutrality Plans In Jeopardy");
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_DESCRIPTION,"An anonymous reader writes EU free");
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_PUBLISHED,"2015-03-05T22:00:00Z");
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_URI,"http://rss.slashdot.org/~r/Slashdot/slashdot/~3/7DWYLD8XMjk/eu-free-data-roaming-net-neutrality-plans-in-jeopardy");
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_URL_REMOTE,"http://rss.slashdot.org/~r/Slashdot/slashdot/~3/7DWYLD8XMjk/eu-free-data-roaming-net-neutrality-plans-in-jeopardy");
        ...
        resultEndpoint.expectedHeaderReceived(Header.PUBLICATION_CREATORS,"timothy");
        ...
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:start").
                        ...
                        setHeader(Header.PUBLICATION_TITLE,             xpath("//rss:item/rss:title/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_DESCRIPTION,       xpath("//rss:item/rss:description/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_PUBLISHED,         xpath("//rss:item/dc:date/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_URI,               xpath("//rss:item/rss:link/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_URL_REMOTE,        xpath("//rss:item/rss:link/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_LANGUAGE,          xpath("//rss:channel/dc:language/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_RIGHTS,            xpath("//rss:channel/dc:rights/text()", String.class).namespaces(ns)).
                        setHeader(Header.PUBLICATION_CREATORS,          xpath("//rss:item/dc:creator/text()", String.class).namespaces(ns)).
