...
public class RSSTest extends CamelTestSupport{
    ...
    public void rssMessage() throws Exception {
        ...
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_TITLE,"EU Free Data Roaming, Net Neutrality Plans In Jeopardy");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_DESCRIPTION,"An anonymous reader writes EU free");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_PUBLISHED,"2015-03-05T22:00:00Z");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_URI,"http://rss.slashdot.org/~r/Slashdot/slashdot/~3/7DWYLD8XMjk/eu-free-data-roaming-net-neutrality-plans-in-jeopardy");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_URL_REMOTE,"http://rss.slashdot.org/~r/Slashdot/slashdot/~3/7DWYLD8XMjk/eu-free-data-roaming-net-neutrality-plans-in-jeopardy");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_LANGUAGE,"en-us");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_RIGHTS,"Copyright 1997-2015, Dice. All Rights Reserved. Slashdot is a Dice Holdings, Inc. service");
        resultEndpoint.expectedHeaderReceived(CollectorProperty.PUBLICATION_CREATORS,"timothy");
    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:start").
                        setHeader(CollectorProperty.SOURCE_NAME,                   constant("slashdot")).
                        setHeader(CollectorProperty.SOURCE_URI,                    constant("http://www.epnoi.org/feeds/slashdot")).
                        setHeader(CollectorProperty.SOURCE_URL,                    constant("http://rss.slashdot.org/Slashdot/slashdot")).
                        setHeader(CollectorProperty.SOURCE_PROTOCOL,               constant("rss")).
                        setHeader(CollectorProperty.PUBLICATION_TITLE,             xpath("//rss:item/rss:title/text()", String.class).namespaces(ns)).
                        setHeader(CollectorProperty.PUBLICATION_DESCRIPTION,       xpath("//rss:item/rss:description/text()", String.class).namespaces(ns)).
                        setHeader(CollectorProperty.PUBLICATION_PUBLISHED,         xpath("//rss:item/dc:date/text()", String.class).namespaces(ns)).
                        setHeader(CollectorProperty.PUBLICATION_URI,               xpath("//rss:item/rss:link/text()", String.class).namespaces(ns)).
                        setHeader(CollectorProperty.PUBLICATION_URL_REMOTE,        xpath("//rss:item/rss:link/text()", String.class).namespaces(ns)).
                        setHeader(CollectorProperty.PUBLICATION_LANGUAGE,          xpath("//rss:channel/dc:language/text()", String.class).namespaces(ns)).
